...
export default function TranslateLesson(): JSX.Element {
  ...
  React.useEffect(() => {
    const timer = setTimeout(() => {
      const utterance = new SpeechSynthesisUtterance("Dear Ana, how are you?");
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      ...
      <div className="relative w-[390px] h-[844px] bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="flex items-center gap-3 px-6 mb-8">
          ...
          <div className="bg-gradient-to-r from-[#1cb0f6] to-[#0ea5e9] text-white text-xs font-bold px-2 py-1 rounded-full shadow-sm">
            More advanced!
          </div>
        </div>
